...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	$result=mysqli_query($con,$query);
      ...
      $rows=$result->fetch_assoc();
				...
				$query_insert="insert into Hostel_guide values ('".$rows['Name']."','".$_SESSION['gstudentID']."','".$rows['Email']."','".$rows['Password']."','".$rows['Phone Number']."','$hostel','$room','$date','$compl_type','$complaint')";
...
<body>
	<form method="post">
		...
		<div class="topnav">
			...
			<a href="RegComplaint.php">LOGIN</a>
